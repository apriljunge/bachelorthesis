...
begin
	...
	a = collect(0.1:0.1:length(vertex_points)/10)

	@debug a
	@debug radii
	
	# Draw vertices
	scatter!(ga, vertex_points, color=radii)

	scatter!(ga, range(1, 4, length = 10), fill(-2, 10), color = [2012.16,986.36, 3, 4, NaN, 6, 7, 8, 9, 10])
